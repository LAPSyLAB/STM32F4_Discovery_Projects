...
#define CFGAPP_DEBUG_LEVEL_CAN       11+512 //!< 0..no print, 1..Warnings, 2..RX parsed, 4..TX parsed, 8..RX raw, 16..TX raw, 256..Status Msgs, 512..BaudSync Mesgs
typedef struct {
//        int      Modbus;
//        int      TCP;
//        int      FP;
