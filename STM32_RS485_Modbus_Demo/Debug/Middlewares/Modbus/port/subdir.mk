...
Middlewares/Modbus/port/%.o Middlewares/Modbus/port/%.su: ../Middlewares/Modbus/port/%.c Middlewares/Modbus/port/subdir.mk
...
clean-Middlewares-2f-Modbus-2f-port:
	-$(RM) ./Middlewares/Modbus/port/portcritical.d ./Middlewares/Modbus/port/portcritical.o ./Middlewares/Modbus/port/portcritical.su ./Middlewares/Modbus/port/portevent.d ./Middlewares/Modbus/port/portevent.o ./Middlewares/Modbus/port/portevent.su ./Middlewares/Modbus/port/portevent_m.d ./Middlewares/Modbus/port/portevent_m.o ./Middlewares/Modbus/port/portevent_m.su ./Middlewares/Modbus/port/portserial.d ./Middlewares/Modbus/port/portserial.o ./Middlewares/Modbus/port/portserial.su ./Middlewares/Modbus/port/portserial_m.d ./Middlewares/Modbus/port/portserial_m.o ./Middlewares/Modbus/port/portserial_m.su ./Middlewares/Modbus/port/porttimer.d ./Middlewares/Modbus/port/porttimer.o ./Middlewares/Modbus/port/porttimer.su ./Middlewares/Modbus/port/porttimer_m.d ./Middlewares/Modbus/port/porttimer_m.o ./Middlewares/Modbus/port/porttimer_m.su
